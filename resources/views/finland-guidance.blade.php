                        ...
                        <form id="get_user_data_form" method="POST" enctype="multipart/form-data">
                            ...
                            @if($type == 'ekas')
                                ...
                                <div class="form-step" id="step-2">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            <span style="float: right; font-size: 1em;">€1</span><label style="font-weight: bold; font-size: 1.2em;">{{ucfirst($type)}} Finland Guidance Document
                                            </label>
