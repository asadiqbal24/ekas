...
<html>
<head>
	<title>{{App\Services\SettingService::getSetting('site_title')}}</title>
					...
					<div class="oks-uni-select" style="background-image: linear-gradient(rgb(0 0 0 / 36%), rgb(0 0 0 / 34%)), url(image/ku-leuven.jpeg);">
						...
						<div class="oks-uni-btn">
							...
							<div class="oks-uni-popup">
								...
								<a href="{{ route('get-courses-top-university', ['universityname' => 'KU Leuven', 'location' => 'Belgium']) }}">Discover Course</a>
						...
						<div class="oks-uni-btn">
							...
							<div class="oks-uni-popup">
								...
								<div class="oks-uni-content">
									...
									<a href="{{ route('get-courses-top-university', ['universityname' => 'Ghent University', 'location' => 'Belgium']) }}">Discover Course</a>
						...
						<div class="oks-uni-btn">
							...
							<div class="oks-uni-popup">
								...
								<div class="oks-uni-content">
									...
									<a href="{{ route('get-courses-top-university', ['universityname' => 'UCLouvain', 'location' => 'Belgium']) }}">Discover Course</a>
						...
						<div class="oks-uni-btn">
							...
							<div class="oks-uni-popup">
								...
								<div class="oks-uni-content">
									...
									<a href="{{ route('get-courses-top-university', ['universityname' => 'Université libre de Bruxelles', 'location' => 'Belgium']) }}">Discover Course</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="oks-uni-select" style="background-image: linear-gradient(rgb(0 0 0 / 36%), rgb(0 0 0 / 34%)), url(image/varija.jpeg);">
						...
						<div class="oks-uni-btn">
							...
							<div class="oks-uni-popup">
                                ...
                                <a href="{{ route('get-courses-top-university', ['universityname' => 'Vrije University of Brussels', 'location' => 'Belgium']) }}">Discover Course</a>
								</div>
							</div>
						</div>
					</div>
