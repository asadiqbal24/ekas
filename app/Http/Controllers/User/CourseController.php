...
class CourseController extends Controller
{
    public function getCourse(Request $request, $name = null)
    {
      ...
      //  dd($course_category);
        ...
        if ($request->ajax()) {
            ...
            return view('courses.index', compact('courses', 'programnames', 'locations', 'univeristies', 'programs', 'country', 'level', 'programmename','course_category'))->with('fragment', 'course_details_section');
        }
    }
    ...
    public function getFilteredDetails(Request $request)
    {
        ...
        if ($request->has('fieldofstudy') && !empty($request->fieldofstudy)) {
            $query->where('fieldofstudy', $request->fieldofstudy);
        }
