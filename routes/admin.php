...
Route::middleware('admin')->group(function () {
    ...
    Route::get('excel/upload', [CourseController::class, 'importData'])->name('import.course.data');
    Route::post('excel/upload', [CourseController::class, 'importExcelData'])->name('import.excel.data');
    Route::post('move/to/trash', [CourseController::class, 'moveToTrash'])->name('move.to.trash');
    Route::get('get/trashed/courses', [CourseController::class, 'getTrashedCourses'])->name('get.trashed.courses');
    Route::post('delete/courses/force', [CourseController::class, 'deleteTrashedCourses'])->name('delete.courses.force');
...
Auth::routes();
  ...
  Route::post('stripePost',[StripeController::class, 'StripePost'])->name('stripePost');